    ...
    <CRMLayout>
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="relative overflow-hidden">
          {/* Gradient background */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#863BFF]/30 via-black to-[#FF40C6]/10" />
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#863BFF]/15 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#FF40C6]/10 rounded-full blur-[100px]" />
          ...
          <div className="relative max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
            ...
            <p className="text-lg text-white/70 max-w-2xl mx-auto mb-8 leading-relaxed" style={{ fontFamily: "Inter, sans-serif" }}>
            ...
            <ChevronDown className="h-6 w-6 text-white/30 mx-auto mt-12 animate-bounce" />
          </div>
        </section>
        ...
        <section className="py-20 px-6 border-t border-white/5">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-white/60 text-lg mb-8 leading-relaxed">
              ...
              <em className="text-white/80">„Da könnte doch mehr möglich sein."</em>
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-8">
              {[
                ...
                <div key={item.label} className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/5 border border-white/10">
                  <item.icon className="h-6 w-6 text-[#863BFF]" />
                  <span className="text-xs text-white/70 text-center">{item.label}</span>
                </div>
              ))}
            </div>

            <div className="bg-gradient-to-r from-[#863BFF]/10 to-transparent border-l-2 border-[#863BFF] pl-6 py-4 rounded-r-lg">
        ...
        <section className="py-20 px-6 bg-gradient-to-b from-transparent via-[#863BFF]/5 to-transparent">
              ...
              {BEISPIELE.map((b, i) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                    activeBeispiel === i
                      ? "bg-[#863BFF] text-white shadow-lg shadow-[#863BFF]/20"
              ...
              return (
                <Card className="bg-white/5 border-white/10 text-white">
                  <CardContent className="p-8">
                    ...
                    <p className="text-white/60 mb-8">{b.beschreibung}</p>

                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-4 rounded-xl bg-white/5">
                        <p className="text-xs text-white/40 mb-1">Marktwert vorher</p>
                        <p className="text-xl font-bold">{b.vorher}</p>
                      </div>
                      <div className="text-center p-4 rounded-xl bg-[#863BFF]/10 border border-[#863BFF]/20">
                      ...
                      <div className="text-center p-4 rounded-xl bg-green-500/10 border border-green-500/20">
                        <p className="text-xs text-green-400/70 mb-1">Neuer Marktwert</p>
                        <p className="text-xl font-bold text-green-400">{b.nachher}</p>
                        <p className="text-xs text-green-400/60 mt-1">{b.mehrwert}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="grid gap-3 max-w-xl mx-auto">
              {LERNZIELE.map((ziel, i) => (
                <div key={i} className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <span className="text-white/80">{ziel}</span>
                </div>
              ))}
            </div>

            <p className="text-center text-white/50 mt-6 italic">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {NICHT_IST.map((item, i) => (
                <div key={i} className="flex items-center gap-2 px-5 py-3 rounded-full bg-white/5 border border-white/10">
        ...
        {/* ── SICHERHEIT / TRUST ── */}
        <section className="py-16 px-6 bg-[#863BFF]/5 border-y border-[#863BFF]/10">
          <div className="max-w-4xl mx-auto">
        ...
        <section id="webinar-video" className="py-20 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Video placeholder */}
            <div className="aspect-video rounded-2xl bg-gradient-to-br from-[#863BFF]/20 to-[#FF40C6]/10 border border-white/10 flex items-center justify-center relative overflow-hidden group cursor-pointer">
              ...
              <div className="relative z-10 flex flex-col items-center gap-4">
                ...
                <p className="text-white/60 text-sm">Webinar starten</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={s.step} className="p-6 rounded-2xl bg-white/5 border border-white/10 text-left">
        ...
        {/* ── FINAL CTA ── */}
        <section className="py-24 px-6 bg-gradient-to-t from-[#863BFF]/10 to-transparent">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 tracking-tight">
        ...
        <footer className="py-8 px-6 border-t border-white/5 text-center">
          <img src={imonduLogo} alt="IMONDU" className="h-8 mx-auto mb-3 opacity-60" />
