        ...
        <div className="p-6 lg:p-8 animate-fade-in min-h-screen dashboard-mesh-bg">
          <div className="max-w-4xl">
            ...
            <Tabs defaultValue="profil" className="w-full">
              ...
              <p className="text-xs text-muted-foreground mt-3 mb-6">Diese Einstellungen gelten für Dein HR-Konto.</p>

              {/* Profil */}
              <TabsContent value="profil" className="space-y-6 mt-0">
                <Separator />
                <SectionBlock title="Persönliche Daten" description="Deine Kontaktdaten.">
              ...
              <TabsContent value="benachrichtigungen" className="space-y-6 mt-0">
                ...
                <SectionBlock title="Benachrichtigungen" description="Steuere, wie Du über Neuigkeiten informiert wirst.">
                  <div className="space-y-4 max-w-lg">
                    {[
                      { label: "E-Mail-Benachrichtigungen", desc: "Erhalte Updates zu neuen Bewerbungen per E-Mail." },
                      { label: "Chat-Benachrichtigungen", desc: "Werde benachrichtigt, wenn Du eine neue Chat-Nachricht erhältst." },
                      { label: "Bewerber-Status-Updates", desc: "Erhalte eine Benachrichtigung, wenn sich der Status eines Bewerbers ändert." },
                    ].map((n) => (
                      <div key={n.label} className="flex items-center justify-between gap-4 p-3 rounded-lg border border-border hover:bg-secondary/30 transition-colors">
                        <div>
